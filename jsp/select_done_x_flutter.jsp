...
<%
    ...
    String WhereDefault = "select seq, checkvalue, listname, Date(insertdate), donedate from listTodo where checkvalue=0 and deletestatus = 0 order by checkvalue, donedate desc,insertdate desc";
