...
<%
    ...
    String WhereDefault = "select seq, checkvalue, listname, DATE(deletedate) from listTodo WHERE deletestatus = 1 and deletedate >= DATE_SUB(NOW(), INTERVAL 30 DAY)";
    ...
    try {
        ...
        while (rs.next()){
            ...
            tempJson.put("deletelist", rs.getString(3));
